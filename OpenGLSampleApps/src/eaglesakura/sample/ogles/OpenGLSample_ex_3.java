...
public class OpenGLSample_ex_3 extends WallpaperService
{
    ...
    public class GLEngineRender
    {
        ...
        {
            float tw = ( float ) w / ( float ) textureWidth, th = ( float ) h / ( float ) textureHeight, tx = ( float ) x
                                                                                                              / ( float ) textureWidth, ty = ( float ) y
                                                                                                                                             / ( float ) textureHeight;
